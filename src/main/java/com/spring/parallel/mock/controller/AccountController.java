...
public class AccountController {
    ...
    Mono<AccountBasicDetails> getAccountById(@PathVariable String accountId) {
        return getAccount(accountId);
    }


    private Mono<AccountBasicDetails> getAccount(String accountId) {
        ...
        return Mono.just(AccountBasicDetails.builder()
                .accountId(accountId)
